...
function AppShell() {
  ...
  if (loading) {
    return (
      <SafeAreaView style={[styles.loadingSafeArea, { backgroundColor: colors.background }]}>
        <View style={styles.loadingContent}>
          <ActivityIndicator color={colors.primary} size="large" />
          <Text style={[styles.loadingTitle, { color: colors.text }]}>Preparing your TuonTa! space...</Text>
          <Text style={[styles.loadingSubtitle, { color: colors.muted }]}>Setting up your next step.</Text>
        </View>
      </SafeAreaView>
    );
  }
